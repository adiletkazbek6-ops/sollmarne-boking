...
export const menu: MenuItem[] = [
  ...
  { id: "sa3", category: "salads", name: "Цезарь с креветками", description: "Тигровые креветки, пармезан, чиабатта, соус цезарь", price: 3400, image: IMG.caesarShrimp },
  { id: "sa4", category: "salads", name: "Тёплый салат с кониной", description: "Сочная конина, обжаренные овощи, тёплая заправка", price: 3300, image: IMG.warmHorse },
  { id: "sa5", category: "salads", name: "Салат с морепродуктами", description: "Кальмары, креветки, мидии, микс салатов", price: 3890, image: IMG.seafoodSalad },
  { id: "sa6", category: "salads", name: "Ачучук", description: "Классический узбекский салат — томаты, лук, зелень", price: 1890, image: IMG.achuchuk },
  { id: "sa7", category: "salads", name: "Салат с руколой и лососем", description: "Слабосолёный лосось, рукола, черри, цитрусовая заправка", price: 3790, image: IMG.arugulaSalmon },

  // ============ СУПЫ ============
  { id: "su1", category: "soups", name: "Рыбная солянка", description: "Наваристая солянка с ассорти рыбы и оливками", price: 3200, image: IMG.solyanka },
  { id: "su2", category: "soups", name: "Уха по-царски", description: "Три вида рыбы, шафран, водка, зелень", price: 2900, image: IMG.uha },
  { id: "su3", category: "soups", name: "Грибной крем-суп", description: "Шампиньоны и лесные грибы со сливками", price: 2900, image: IMG.mushroomCream },
  { id: "su4", category: "soups", name: "Том-ям с рисом", description: "Острый тайский суп с креветками и рисом", price: 4390, image: IMG.tomyam, spicy: true },
  ...
  { id: "su6", category: "soups", name: "Куриный суп-лапша", description: "Прозрачный бульон, домашняя лапша, курица", price: 2200, image: IMG.chickenNoodle },
  { id: "su7", category: "soups", name: "Похмельный супчик", description: "Острый, наваристый — идеален для бодрого утра", price: 2500, image: IMG.hangover, spicy: true },

  // ============ ЗАКУСКИ ============
  { id: "st1", category: "starters", name: "Овощная нарезка", description: "Огурец, томат, болгарский перец, зелень, редис", price: 2790, image: IMG.veggieCut },
  { id: "st2", category: "starters", name: "Русская закуска", description: "Сало, селёдка под лучком, малосольный огурец", price: 3890, image: IMG.russianStarter },
  { id: "st3", category: "starters", name: "Закуска к вину", description: "Ассорти сыров, виноград, мёд, орехи", price: 7590, image: IMG.wineSnack },
  { id: "st4", category: "starters", name: "Перчики тонато", description: "Сладкие перцы с соусом тоннато из тунца", price: 4100, image: IMG.pepperTonnato },
  { id: "st5", category: "starters", name: "Рыбные стрипсы", description: "Хрустящие полоски белой рыбы, соус тартар", price: 2500, image: IMG.fishStrips },
  { id: "st6", category: "starters", name: "Куриные наггетсы", description: "В пряной панировке, соусы на выбор", price: 1600, image: IMG.nuggets },
  { id: "st7", category: "starters", name: "Хрустящие гренки", description: "Ржаной хлеб с чесноком и сырным соусом", price: 1190, image: IMG.garlicToast },
  { id: "st8", category: "starters", name: "Луковые кольца", description: "В золотистом кляре, соус ранч", price: 1590, image: IMG.onionRings },
  { id: "st9", category: "starters", name: "Жареный чечил", description: "Копчёный сыр чечил во фритюре", price: 1390, image: IMG.chechilCheese },
  { id: "st10", category: "starters", name: "Сырные палочки", description: "Моцарелла во фритюре, клюквенный соус", price: 2300, image: IMG.cheeseSticks },
  { id: "st11", category: "starters", name: "Пивные креветки", description: "Отваренные креветки с лимоном и специями", price: 5890, image: IMG.beerShrimp },
  { id: "st12", category: "starters", name: "Креветки темпура", description: "Тигровые креветки в темпуре, соус sweet chili", price: 3900, image: IMG.tempuraShrimp },
  { id: "st13", category: "starters", name: "Ассорти колбасок", description: "Микс жареных колбасок с горчицей и квашеной капустой", price: 5500, image: IMG.sausagePlate },

  // ============ ПАСТА ============
  { id: "pa1", category: "pasta", name: "Спагетти болоньезе", description: "Мраморная говядина, томлёный соус 6 часов", price: 2600, image: IMG.bolognese },
  { id: "pa2", category: "pasta", name: "Феттучини с курицей и грибами", description: "Нежная курица, шампиньоны, сливочный соус", price: 3190, image: IMG.fettuccine },
  { id: "pa3", category: "pasta", name: "Паста с лососем и соусом песто", description: "Норвежский лосось, базилик, кедровый орех", price: 3790, image: IMG.salmonPesto },
  { id: "pa4", category: "pasta", name: "Паста с фрикадельками", description: "Домашние фрикадельки в томатном соусе", price: 2100, image: IMG.pastaMeatballs },
  { id: "pa5", category: "pasta", name: "Паппарделле с кониной", description: "Широкая лапша с томлёной кониной", price: 2900, image: IMG.pappardelle },
  { id: "pa6", category: "pasta", name: "Паста с морепродуктами", description: "Кальмар, креветки, мидии, томатно-сливочный соус", price: 3890, image: IMG.pastaSeafood },

  // ============ ПИЦЦА И БУРГЕРЫ ============
  { id: "pz1", category: "pizza", name: "Пицца «Пепперони» 30 см", description: "Острая пепперони, томатный соус, моцарелла", price: 3590, image: IMG.pepperoni },
  { id: "pz2", category: "pizza", name: "Пицца «Болоньезе» 30 см", description: "Мясной соус болоньезе, моцарелла, базилик", price: 3200, image: IMG.pizzaBolognese },
  { id: "pz3", category: "pizza", name: "Пицца «Охотничья» 30 см", description: "Охотничьи колбаски, маринованные огурцы, моцарелла", price: 4100, image: IMG.pizzaHunter },
  { id: "pz4", category: "pizza", name: "Пицца «Курица с грибами» 30 см", description: "Курица, шампиньоны, моцарелла, сливочный соус", price: 3790, image: IMG.pizzaChicken },
  { id: "pz5", category: "pizza", name: "Пицца с голубым сыром и медовой грушей 30 см", description: "Дор блю, груша в мёду, моцарелла, тимьян", price: 4290, image: IMG.pizzaBlueCheese },
  { id: "pz6", category: "pizza", name: "Пицца «Маргарита» 30 см", description: "Моцарелла фьор ди латте, томаты, базилик", price: 3100, image: IMG.margherita },
  { id: "pz7", category: "pizza", name: "Бургер с рваной говядиной", description: "Томлёная говядина, BBQ, карамелизированный лук", price: 4090, image: IMG.burgerPulled },
  { id: "pz8", category: "pizza", name: "Бургер Sollmarine Fish", description: "Котлета из белой рыбы, тартар, огурец, салат", price: 3990, image: IMG.burgerFish },

  // ============ МЯСО · ПТИЦА ============
  { id: "me1", category: "meat", name: "Мясо по-строгановски с пюре", description: "Бефстроганов в сливочно-горчичном соусе с пюре", price: 3900, image: IMG.stroganoff },
  { id: "me2", category: "meat", name: "Говяжьи рёбра с молодым картофелем", description: "Томлёные 6 часов, BBQ соус, молодой картофель", price: 6990, image: IMG.beefRibs },
  { id: "me3", category: "meat", name: "Томлёная конина в соусе чимичури", description: "Нежная конина с пряным аргентинским соусом", price: 6900, image: IMG.horseChimichurri },
  { id: "me4", category: "meat", name: "Стейк Рибай", description: "Мраморная говядина, выдержка, средняя прожарка", price: 9700, image: IMG.ribeye },
  { id: "me5", category: "meat", name: "Стейк Т-бон", description: "Говядина на кости, соус на выбор", price: 9700, image: IMG.tbone },
  { id: "me6", category: "meat", name: "Стейк Шато", description: "Премиальный отруб филе-миньон", price: 6990, image: IMG.chateauSteak },
  { id: "me7", category: "meat", name: "Шеф-стейк конины", description: "Авторский стейк из выдержанной конины", price: 7900, image: IMG.horseSteak },
  { id: "me8", category: "meat", name: "Цыплёнок гриль с овощами", description: "Сочный цыплёнок с овощами гриль", price: 3270, image: IMG.grillChicken },
  { id: "me9", category: "meat", name: "Курица по-милански", description: "Куриное филе в панировке, томаты, моцарелла", price: 3270, image: IMG.milanese },
  { id: "me10", category: "meat", name: "Перепёлка со сливочным портобелло", description: "Запечённая перепёлка с соусом из портобелло", price: 2890, image: IMG.quail },
  { id: "me11", category: "meat", name: "Фрикасе с блинчиками", description: "Куриное фрикасе в сливочном соусе с блинами", price: 2500, image: IMG.fricassee },
  { id: "me12", category: "meat", name: "Куриные фрикадельки с пюре", description: "Нежные фрикадельки и картофельное пюре", price: 2000, image: IMG.chickenMeatballs },
  ...
  // ============ РЫБА · ОСЁТР ============
  { id: "fi1", category: "fish", name: "Сазан жареный / запечённый", description: "Каспийский сазан с овощами и лимоном", price: 6000, image: IMG.sazan },
  { id: "fi2", category: "fish", name: "Кефаль жареная / запечённая", description: "Свежая кефаль с лимоном и травами", price: 3300, image: IMG.kefal },
  ...
  { id: "fi5", category: "fish", name: "Дорадо запечённая", description: "Дорадо на соли с травами Прованса", price: 7390, image: IMG.dorado },
  { id: "fi6", category: "fish", name: "Сибас запечённый", description: "Сибас в соляной корке с лимоном", price: 6290, image: IMG.seabass },
  { id: "fi7", category: "fish", name: "Стейк осетра со спаржей", description: "Сочный стейк осетра с гриль-спаржей", price: 6900, image: IMG.sturgeonAsparagus },
  { id: "fi8", category: "fish", name: "Осётр гречотто", description: "Филе осетра на гречневом ризотто со сливками", price: 6490, image: IMG.sturgeonGrechotto },
  { id: "fi9", category: "fish", name: "Гёдза с осетром", description: "Японские пельмени гёдза с начинкой из осетра", price: 4100, image: IMG.sturgeonGyoza },
  { id: "fi10", category: "fish", name: "Тельное из осетра", description: "Русское фирменное блюдо — фарш из осетра в тесте", price: 4200, image: IMG.sturgeonTelnoe },
  { id: "fi11", category: "fish", name: "Фишбармак из осетра", description: "Авторский фишбармак на основе осетрины", price: 4500, image: IMG.fishbarmak },

  // ============ СЕТЫ · БАНКЕТЫ ============
  { id: "se1", category: "sets", name: "Малый рыбный сет", description: "На 2–3 гостей: ассорти рыбных блюд", price: 11490, image: IMG.smallFishSet },
  { id: "se2", category: "sets", name: "Сет из птицы", description: "На 4–5 гостей: микс блюд из птицы", price: 16900, image: IMG.setPoultry },
  { id: "se3", category: "sets", name: "Большой рыбный сет", description: "На 4–5 гостей: разнообразие рыбных деликатесов", price: 36000, image: IMG.bigFishSet },
  ...
  // ============ ГАРНИРЫ ============
  { id: "sd1", category: "sides", name: "Брокколи в соусе", description: "Хрустящая брокколи в фирменном соусе", price: 1900, image: IMG.broccoli },
  { id: "sd2", category: "sides", name: "Картофельные шарики", description: "Хрустящие шарики с сыром", price: 1290, image: IMG.potatoBalls },
  ...
  { id: "sd6", category: "sides", name: "Овощи гриль", description: "Баклажан, цукини, перец, томат", price: 1790, image: IMG.grillVeg },
